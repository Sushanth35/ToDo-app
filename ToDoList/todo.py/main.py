...
heading=Label(root,text="TASKS TO DO",font="arial 20 bold",fg="white",bg="#32405b")
...
listbox= Listbox(frame1,font=('arial',12),width=40,height=16,bg="#325b58",fg="white",cursor="hand2",selectbackground="#5a95ff")
